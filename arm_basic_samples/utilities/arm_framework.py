...
def get_list_regions(access_token, subscription_id):
    result_json = [{"id": "centralus","name":"Central US"},{"id":"westus","name":"West US"},{"id":"eastus","name":"East US"},{"id":"northeurope","name":"North Europe"},{"id":"westeurope","name":"West Europe"},{"id":"southeastasia","name":"SouthEast Asia"},{"id":"eastasia","name":"East Asia"},{"id":"japaneast","name":"Japan East"},{"id":"japanwest","name":"Japan West"},{"id":"brazilsouth","name":"Brazil South"},{"id":"southcentralus","name":"SouthCentral US"},{"id":"northcentralus","name":"NorthCentral US"}]
    return result_json
...
def get_list_vm_publishers(access_token, subscription_id,region_name):
    region = region_name
    cred = SubscriptionCloudCredentials(subscription_id,access_token)
    resource_client = ResourceManagementClient(cred, user_agent='SDKSample/1.0')
    resource_client.providers.register('Microsoft.Compute')
    ...
    for res in result_list_pub.resources:
        result_json.append({"name":res.name,"id":res.id})
    return result_json

def get_list_vm_offers(access_token,subscription_id,publisher_name,region_name):
    region = region_name
...
def get_list_vm_skus(access_token,subscription_id,region_name, publisher_name,offer_name):
    region = region_name
    publisher = publisher_name
    offer = offer_name
    cred = SubscriptionCloudCredentials(subscription_id,access_token)
...
def get_list_vm_versions(access_token,subscription_id,region_name,publisher_name,offer_name,sku_name):
    region = region_name
    publisher = publisher_name
    offer = offer_name
    skus = sku_name 
